...
from exp.interface.rememr1_api import ReMemR1_API
import os, csv, json
import argparse
import time
import glob
...
@async_tqdm
async def get_pred_one(item, agent, args, fout, subpbar):
    context = item['context']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-suf", type = str, default = "rememr1_api") 
