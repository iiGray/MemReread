...
#     module_pth = os.path.dirname(os.path.dirname(os.path.dirname(file_pth)))
#     sys.path.insert(0, module_pth)
#     from custom_scores.hotpotqa import compute_score
#     raw_fn = compute_score


#     reward_kwargs = dict(reward_fn_config.get("reward_kwargs", {}))

#     return Wrappfn(raw_fn, **reward_kwargs)
