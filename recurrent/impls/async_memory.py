...
class AsyncMemoryDataset(RDataset):
    ...
    def __getitem__(self, item):
        ...
        row_dict['question'] = row_dict['prompt']
        row_dict['golden_answer'] = row_dict['reward_model']['ground_truth']
        return row_dict
    ...
    def get_bactch_keys(self) -> Tuple[List[str], List[str]]:
        ...
        return ["context_ids", "context_length"], ["prompt", "question", "golden_answer"]
